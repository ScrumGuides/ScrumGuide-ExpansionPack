...
2. **Cohesive** - _All of the components "inside" are related to the job it performs, and everything it needs to do its job is there._
...
**_Imagine how much value could be created if you combined the approaches from both of the second product examples: Agile, grounded in sound software engineering practices._**
...
**Continuous Deployment** - **_Push change into production on an automated basis after every successful change_**
