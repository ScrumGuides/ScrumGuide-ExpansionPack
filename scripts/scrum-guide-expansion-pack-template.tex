...
\newcommand{\coverpage}{
  \begin{titlepage}
    ...
    $if(creator-count)$
    % Display creators horizontally
    \begin{center}
    {\large\textbf{$creator-name-1$}$if(creator-name-2)$ \quad \textbf{$creator-name-2$}$endif$$if(creator-name-3)$ \quad \textbf{$creator-name-3$}$endif$}
    \end{center}
    $else$
